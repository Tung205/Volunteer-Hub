...
const EventCard = ({ event, onClick }) => {
  return (
    <div className="bg-white border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition flex overflow-hidden min-h-[8rem] h-auto">

      <div className="w-1/3 md:w-36 flex-shrink-0 bg-gray-200">
        <img
          src={event.imageUrl}
          alt={event.title}
          loading="lazy"
