import React, { useState, useEffect } from 'react'; // <--- 1. SỬA LỖI: Thêm useState, useEffect
  ...
  return (
    ...
    <nav className="sticky top-0 z-50 bg-white shadow-md h-20">
      <div className="max-w-7xl mx-auto px-6 py-3 grid grid-cols-2 md:grid-cols-3 items-center h-full">
        ...
        {isAuthenticated ? (
          <div className="flex justify-end relative"> {/* <--- 2. SỬA LỖI: Thêm flex justify-end để icon dính phải */}
            <button 
